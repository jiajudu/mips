...
#define readwatchlo()	readcp0($18)
#define writewatchlo(val)	writecp0($18, val)
#define readwatchhi()	readcp0($19)
#define writewatchhi(val)	writecp0($19, val)
#define readcp0(source)	                            \
({                                                  \
    int __res;								        \
...
#define writecp0(register, value)	                \
do {									            \
	__asm__ __volatile__(					        \
	"mtc0\t%z0, " #register "\n\t"			        \
